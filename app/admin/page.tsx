...
const AdminDashboard = async () => {
  ...
  <p className="text-lg text-center mb-12">Bem-vindo ao painel de controle da From Stars 3D. Aqui você pode gerenciar orçamentos, pedidos e conteúdo do site.</p>
