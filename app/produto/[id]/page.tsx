...
// Define o tipo das props que a página recebe
...
// Gera metadados de SEO dinamicamente
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      images: [{ url: product.imagem, alt: product.nome }],
    },
  };
}
      ...
      <div className="max-w-4xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-white mb-6">R$ {product.preco.toFixed(2).replace('.', ',')}</p>
